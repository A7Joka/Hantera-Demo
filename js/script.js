...
const desiredCupsOrder = [
  // 🏆 Tier S+ | البطولات الدولية الكبرى
  ...
  // ⚽ Tier S | بطولات الأندية النخبوية
  "دوري أبطال أوروبا",
  ...
  // 🥈 Tier B | بطولات أوروبية وأمريكية شعبية
  ...
  // 🌍 Tier C | بطولات ناشئة أو بمتابعة أقل
  "دوري أبطال آسيا 2",
